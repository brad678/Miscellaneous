...
- There is a slow upward rising trend
...
- Trend is increasing mostly and decreasing in between but overall can find a rising trend from 2221 to 4565 millions (trend increased 105% over a period of 10 years from 1999 to 2009)
...
```{r}
fitlm <- tslm(revenuests ~ trend + season)
summary(fitlm)
