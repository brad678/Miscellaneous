...
### Project details: 
http://rcodeeasy.blogspot.sg/2014/06/time-series-models-detailed-explanation.html
...
summary(fort.fitlmAdd)

```

### Plot the graph for linear Additive model

```{r}
#plot the graph

plot.ts(revenuests,xlim=c(1999,2011),ylim=c(1500,6000)) #plot actual data
lines(fort.fitlmAdd$fitted,col='green')                 #fit the historical fitted values
lines(fort.fitlmAdd$mean,col='blue')                    #fit the future predicted values
lines(fort.fitlmAdd$lower[,2],col='red')                #fit the lower interval
lines(fort.fitlmAdd$upper[,2],col='red')                #fit the upper interval
...
### Predict using linear Multiplicative model
...
summary(fort.fitlmMul)

```


### Plot the graph for linear Multiplicative model

```{r}
#plot the graph

plot.ts(revenuests,xlim=c(1999,2011),ylim=c(1500,6000)) #plot actual data
lines(fort.fitlmMul$fitted,col='green')                 #fit the historical fitted values
lines(fort.fitlmMul$mean,col='blue')                    #fit the future predicted values
lines(fort.fitlmMul$lower[,2],col='red')                #fit the lower interval
lines(fort.fitlmMul$upper[,2],col='red')                #fit the upper interval
