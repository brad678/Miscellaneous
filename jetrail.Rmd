...
for(i in 0:23)
{
  ...
  temp_train$OOF_pred_xgbi<-model_xgbi$pred$pred[order(model_xgbi$pred$rowIndex)]
  ...
  temp_train$OOF_pred_svmri<-model_svmri$pred$pred[order(model_svmri$pred$rowIndex)]
  ######
  temp_test$OOF_pred_xgbi <- predict(model_xgbi,temp_test[,predictors])
  temp_test$OOF_pred_svmri <- predict(model_svmri,temp_test[,predictors])
  ######
  predictors_top <- c('OOF_pred_xgbi','OOF_pred_svmri') 
  set.seed(101)
