...
confusionMatrix(predict_model_lr,testSet[,outcomeName],positive = 'Y')
...
confusionMatrix(predict_model_rf,testSet[,outcomeName],positive = 'Y')
...
confusionMatrix(predict_model_knn,testSet1[,outcomeName],positive = 'Y')
...
confusionMatrix(predict_model_rpart,testSet[,outcomeName],positive = 'Y')
...
confusionMatrix(predict_model_nb,testSet[,outcomeName],positive = 'Y')
...
confusionMatrix(predict_model_svm,testSet1[,outcomeName],positive = 'Y')
...
model_gbm <- train(trainSet[,predictors_top],trainSet[,outcomeName],method='gbm',trControl=fitControl)
...
tunegrid <- expand.grid(mtry=c(1:15), ntree=c(300, 500,100,1500, 2000, 2500))
model_rf_tune <- train(trainSet[,predictors],trainSet[,outcomeName],method='rf',trControl=Control,tuneGrid=tunegrid)
